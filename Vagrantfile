...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "api.command.local"
  # config.hostsupdater.aliases = ["api.command-api.local", "www.command-api.local"]
  ...
  #todo In future will probably swap this out with something like Puphpet
